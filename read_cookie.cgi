...
my @names = ("First Name", "Last Name", "Billing Address 1", "Billing Address 2", "City", "State", "Zip", "Phone", "First Name", "Last Name", "Shipping Address 1", "Shipping Address 2", "City", "State", "Zipcode", "Phone Number", "Payment Type", "Card Number", "Expiration Month", "Expiration Year", "Shipping Information");

my $counter = 0;

print "<h4>Thank you for your purchase</h4>\n";
